...
public class GalbsDialogPlus {

  private static final int INVALID = -1;

  /**
   * GalbsDialogPlus base layout root view
   */
  private final ViewGroup rootView;

  /**
   * GalbsDialogPlus content container which is a different layout rather than base layout
   */
  ...
  GalbsDialogPlus(DialogPlusBuilder builder) {
    ...
    rootView = (ViewGroup) layoutInflater.inflate(R.layout.dialog_base_container_layout, decorView, false);
  ...
  public View getContentView(LayoutInflater layoutInflater) {
    if (null == holder || null == rootView) {
      return null;
    }
    return holder.getView(layoutInflater, rootView);
  }
        ...
        decorView.post(new Runnable() {
          ...
          public void run() {
            ...
            if (onDismissListener != null) {
              onDismissListener.onDismiss(GalbsDialogPlus.this);
            }
          }
        });
      }
    ...
    if (adapter != null && holder instanceof HolderAdapter) {
      ...
      holderAdapter.setOnItemClickListener(new OnHolderListener() {
        ...
        public void onItemClick(Object item, View view, int position) {
          ...
          onItemClickListener.onItemClick(GalbsDialogPlus.this, item, view, position);
        }
      });
    }
    return view;
  ...
  private void setClickListener(View view) {
    ...
    view.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        onClickListener.onClick(GalbsDialogPlus.this, v);
      }
    });
  }
          ...
          case KeyEvent.ACTION_UP:
            if (keyCode == KeyEvent.KEYCODE_BACK) {
              if (onBackPressListener != null) {
                onBackPressListener.onBackPressed(GalbsDialogPlus.this);
              }
              if (isCancelable) {
                onBackPressed(GalbsDialogPlus.this);
              }
              return true;
            }
            break;
   ...
   *
   * @param galbsDialogPlus is the current dialog
   */
  public void onBackPressed(GalbsDialogPlus galbsDialogPlus) {
    if (onCancelListener != null) {
      onCancelListener.onCancel(GalbsDialogPlus.this);
    }
    dismiss();
  }
