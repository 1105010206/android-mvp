...
final class Utils {
  ...
  static int getAnimationResource(int gravity, boolean isInAnimation) {
    if ((gravity & Gravity.TOP) == Gravity.TOP) {
      return isInAnimation ? R.anim.dialog_slide_in_top : R.anim.dialog_slide_out_top;
    }
    ...
    if ((gravity & Gravity.CENTER) == Gravity.CENTER) {
      return isInAnimation ? R.anim.dialog_slide_in_center : R.anim.dialog_slide_out_center;
    }
    return INVALID;
  }
}
